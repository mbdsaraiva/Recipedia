      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <header className="header">
          <div className="container flex justify-between items-center">
            <h1 className="text-gradient" style={{fontSize: '1.5rem', fontWeight: 'bold'}}>Recipedia</h1>
            <div>
        ...
        <main className="container py-8">
          <Routes>
            <Route 
              ...
              element={
                <div className="text-center">
                  <h2 style={{fontSize: '2rem', marginBottom: '1rem'}}>Bem-vindo ao Recipedia!</h2>
                  <p className="text-gray-600">
                    Seu sistema de gerenciamento de receitas e ingredientes está funcionando!
                  </p>
                  <div className="card" style={{marginTop: '2rem', textAlign: 'left'}}>
                    <h3>Status da Conexão:</h3>
                    <p style={{color: '#10b981'}}>✅ API Backend conectada</p>
                    <p style={{color: '#10b981'}}>✅ Frontend funcionando</p>
                    <p style={{color: '#f59e0b'}}>⏳ Componentes sendo criados...</p>
                  </div>
                </div>
              } 
            />
